...
const { raiseComplaint, getAllComplaints , updateComplaintStatus, getComplaintCount, getAllComplaintsByUser, getComplaintCountByUser} = require("../controller/complaint.controller");
